...
export const MagneticButton = ({ 
  ...
  const baseStyles = "relative overflow-hidden px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-sm tracking-wide transition-all duration-300 flex items-center justify-center gap-2.5";
  const variantStyles = {
