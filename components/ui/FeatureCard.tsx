...
export const FeatureCard = ({
  ...
  return (
    ...
    >
      <motion.div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-steel-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      <div className="relative z-10">
        ...
        <h3 className="text-xl lg:text-2xl font-semibold text-graphite-50 mb-4 leading-tight">
          {title}
        </h3>
        <p className="text-base text-graphite-400 leading-relaxed">
          {description}
        </p>
      </div>

      {/* Hover arrow removed per design request */}
    </motion.div>
  );
};
